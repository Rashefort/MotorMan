"""
Django settings for motorman project.
...
WSGI_APPLICATION = 'motorman.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'motorman.db'),
    }
}
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, '_files', 'assets'),
)
